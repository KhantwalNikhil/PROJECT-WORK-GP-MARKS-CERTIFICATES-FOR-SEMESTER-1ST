...
int main(){
  ...
  if(ch==1){
    ...
    if(vh==1){
      ...
      printf("Enter the cost of car(On Road Price): ");
      scanf("%f",&cost);
      ...
      p=mloan+1;
      while (p>mloan){
        printf("Enter the amount of loan the customer wants to avail: ");
        scanf("%f",&p);
        if(p>mloan){  
      ...
      while(n>5){
        ...
        scanf("%f",&n);
        if(n>5){
          printf("\nDuration for loan is maximum 5 years\n");
        }
      }
      printf("\n\nInstallments for two months: 6%r.a.\n");
      printf("No Installments for two months: 8%r.a.\n");
      printf("\nAre you willing to pay installments for two months?(Y/N): ");
      scanf("%s",&choice);
    ...
    //Two-wheeler Loan:
      ...
      printf("]\n\nInstallments for two months: 4%%r.a.\n");
